...
public class PersonCommodityBuyActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UPDATE_NOTBUYED:
                    ...
                    break;
                case UPDATE_BUYEDE:
                    CommodityBuyedlListAdapter listAdapter = new CommodityBuyedlListAdapter(commodityRecords,PersonCommodityBuyActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_commodity_buyed);
    ...
    private void getCommodityBuy() {
        final String urlFindMessage = URLpath.BASE_URL+URLpath.GET_CommodityBUY_URL;
    ...
    private void initViewID() {
        ...
        listView =findViewById(R.id.commodity_buy_list);
        refreshLayout = findViewById(R.id.refresh_personBUYed);
    }
}
