...
import com.example.trading_android.activity.PersonCommodityBuyedInfoActivity;
...
public class CommodityBuyedlListAdapter extends BaseAdapter {
    private List<CommodityRecord> listData;
    private LayoutInflater inflater;
    private Context context;

    public CommodityBuyedlListAdapter(List<CommodityRecord> listData, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (listData.get(position).getState() ==0) {
            ...
            holder.commodityChose.setText("收货");
        }else{
        ...
        holder.commodityCentent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, PersonCommodityBuyedInfoActivity.class);
